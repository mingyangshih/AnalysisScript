...
fs.createReadStream(file)
  ...
  .on("end", () => {
    ...
    let gameRevenueReport = _.chain(game)
      ...
      .map((events) => {
        ...
        return {
          uuid,
          pagepath,
          sessionCount: pageSessionCounts[pagepath] || 0,
    ...
    const gameCsvOutput = gameRevenueReport.map(
      (stat) =>
        `${stat.pagepath},${stat.uniqueUsers},${stat.totalEvents},${stat.avgTimeSpent},${stat.sessionCount},` +
